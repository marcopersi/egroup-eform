...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ch.egroup.eform.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ch.egroup.eform.repository.UserRepository.USERS_BY_EMAIL_CACHE);
